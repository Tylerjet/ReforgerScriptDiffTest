...
{	
	...
	[Attribute("", UIWidgets.ResourceNamePicker, "Gauge overlay texture.", "edds")]
	ResourceName m_sOverlay;	

	[Attribute("", UIWidgets.ResourceNamePicker, "Gauge custom needle texture. If not selected, default is used.", "edds")]

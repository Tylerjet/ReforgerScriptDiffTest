class BasicButtonComponent : ScriptedWidgetComponent
{
	...
	override bool OnClick(Widget w, int x, int y, int button)
	{
		...
		WidgetAnimator.PlayAnimation(w, WidgetAnimationType.Color, COLOR_PRESSED, WidgetAnimator.FADE_RATE_DEFAULT);
		return false;
	}
	...
	override bool OnFocus(Widget w, int x, int y)
	{
		...
		WidgetAnimator.PlayAnimation(w, WidgetAnimationType.Color, COLOR_FOCUSED, WidgetAnimator.FADE_RATE_DEFAULT);
		return false;
	}
	...
	{
		WidgetAnimator.PlayAnimation(w, WidgetAnimationType.Color, COLOR_DEFAULT, WidgetAnimator.FADE_RATE_DEFAULT);
		return false;
	}

...
class SCR_LineGeneratorBaseEntity : SCR_GeneratorBaseEntity
{
	...
	*/
	...
	protected override int _WB_GetAfterWorldUpdateSpecs(IEntitySource src)
	{
		...
		return EEntityFrameUpdateSpecs.CALL_ALWAYS; // TODO: change later, CALL_ALWAYS is to be avoided
//		return EEntityFrameUpdateSpecs.CALL_WHEN_ENTITY_VISIBLE;	// the visible entity is the shape, not the generator
//		return EEntityFrameUpdateSpecs.CALL_WHEN_ENTITY_SELECTED;	// how to delete after deselection?
	}

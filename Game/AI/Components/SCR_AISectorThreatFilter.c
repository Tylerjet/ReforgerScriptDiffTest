...
class SCR_AISectorThreatFilter
{
	...
	protected int m_iSectorMajor; // ID of major sector, or -1
	protected int m_iSectorMinor; // ID of minor sectorm, or -1
	...
	const float REFERENCE_RATE_OF_FIRE = 650.0 / 60.0; // Rate of fire of AK-74, very common weapon
	const float REFERENCE_DISTANCE_INV = 1/100; // 100m

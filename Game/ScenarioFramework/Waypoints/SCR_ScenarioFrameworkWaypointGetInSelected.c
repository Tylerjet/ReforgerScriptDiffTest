//------------------------------------------------------------------------------------------------
[BaseContainerProps()]
class SCR_ScenarioFrameworkWaypointGetInSelected : SCR_ScenarioFrameworkWaypointBoarding
{
	[Attribute(defvalue: "2", desc: "Radius in m")]
	float m_fCompletionRadius;

	[Attribute(defvalue: "{8AD8C82346156494}Prefabs/AI/Waypoints/AIWaypoint_GetInSelected.et", desc: "In Default, it will use specific prefab for each class, but here you can change it if you know what you are doing")]
	...
	[Attribute("0", UIWidgets.EditBox, "Minimal time to hold the waypoint before it completes")]

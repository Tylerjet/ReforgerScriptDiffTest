...
class SCR_EntityAssetList
{
	[Attribute(desc: "Asset list")]
	protected ref array<ref SCR_EntityInfo> m_aAssetList;
	...
	*/
	...
	{
		SCR_EntityInfo entityInfo = GetEntryAtIndex(index);
		if (entityInfo)
		{
	...
	*/
	...
	//------------------------------------------------------------------------------------------------
	void SCR_EntityAssetList(array<ref SCR_EntityInfo> assetList = null)
	{

...
//~ ScriptInvokers
void SupportStation_OnSupportStationExecuted(SCR_BaseSupportStationComponent supportStation, ESupportStationType supportStationType, IEntity actionOwner, IEntity actionUser, SCR_BaseUseSupportStationAction action);
typedef func SupportStation_OnSupportStationExecuted;

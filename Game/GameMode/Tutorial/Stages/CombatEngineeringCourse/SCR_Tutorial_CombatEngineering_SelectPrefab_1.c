...
class SCR_Tutorial_CombatEngineering_SelectPrefab_1Class : SCR_BaseTutorialStageClass
{
}

class SCR_Tutorial_CombatEngineering_SelectPrefab_1 : SCR_BaseTutorialStage
{

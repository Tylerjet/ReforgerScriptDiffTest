//------------------------------------------------------------------------------------------------
class SCR_AutomaticRespawnHandlerComponentClass: SCR_RespawnHandlerComponentClass
{
};
...
*/
class SCR_AutomaticRespawnHandlerComponent : SCR_RespawnHandlerComponent
{

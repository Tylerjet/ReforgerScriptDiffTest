...
*/
class SCR_CustomCameraShakeProgress : SCR_CameraShakeProgress
{
	...
	override void Start(float linearMagnitude, float angularMagnitude, float inTime, float sustainTime, float outTime)
	{

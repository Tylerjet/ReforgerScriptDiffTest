...
class SCR_SplitNotificationUIInfo : SCR_UINotificationInfo
{
	...
	*/
	...
	eg: Player Killed player. If Right (killed player) is friendly with Left (killer) then Left will be colored the same color. 
	...
	\return wether or not it should check if factions are friendly and replace the colors if so
	*/

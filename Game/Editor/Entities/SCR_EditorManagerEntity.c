...
- The entity's **components (SCR_BaseEditorComponent) and modes (SCR_EditorModeEntity) handle actual editor features** like camera or user interface.
- Access rights are defined here. When attempting to open or close the editor, the entity checks with the server if it's allowed.
*/

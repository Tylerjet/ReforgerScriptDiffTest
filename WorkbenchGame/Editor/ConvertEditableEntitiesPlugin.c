...
class ConvertEditableEntitiesPlugin: PrefabEditingPluginBase
{
	...
	void ButtonToEditable()
	{
		Convert(true);
	}
	[ButtonAttribute("To Non-editable")]
	void ButtonToNonEditable()
	{
		Convert(false);
	}
...
class ConvertEditableEntitiesPluginResourceManager: ConvertEditableEntitiesPlugin
{

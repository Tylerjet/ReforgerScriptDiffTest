...
class TerrainExportTool : WorldEditorTool
{
	...
	[Attribute(defvalue: "C:\\Program Files\\Blender Foundation\\Blender 3.4\\blender.exe", UIWidgets.FileNamePicker, desc: "Absolute path to your FBX Report Tool .exe", params: "exe FileNameFormat=absolute", category: "Path")]
	...
	// snapping coords to the nearest vertex

...
sealed class UniformGridSlot
{
	private void UniformGridSlot();
	private void ~UniformGridSlot();
	...
	static proto void SetHorizontalAlign(notnull Widget widget, LayoutHorizontalAlign hAlign);
	static proto void SetVerticalAlign(notnull Widget widget, LayoutVerticalAlign vAlign);
};
